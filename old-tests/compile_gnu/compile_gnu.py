...
def test(tparams, res):
	...
	os.system('make clean CORE=init_atmosphere')
	os.system('make clean CORE=atmosphere')
	...
	os.system('time make gfortran CORE=atmosphere PRECISION=single')
	os.system('make clean CORE=init_atmosphere > clean.init.log 2>&1')
	os.system('make clean CORE=atmosphere > clean.model.log 2>&1')
